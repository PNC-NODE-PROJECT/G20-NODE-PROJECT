...
router.post('/', (req, res) => {
    ...
    let new_question = {id:uuidv4(),"question":questions,"answer":{"answer_a":answer_a,"answer_b":answer_b,"answer_c":answer_c,"answer_d":answer_d},"correctAnswer":correctAnswer};
